...
>
  <div
    class="absolute inset-0 z-20 bg-zinc-900/75 flex justify-center flex-col"
  >
    <div
    ...
    >
      <h1
        class="text-2xl md:text-4xl lg:text-7xl font-bold mb-2 max-w-4xl"
        data-placeholder="Här kan vi skriva en placeholder-text"
      >
        {heading}
      </h1>
      <p
        class="max-w-2xl text-lg mb-7"
        data-placeholder="Här kan vi skriva en placeholder-text"
      >
        {text}
      </p>
